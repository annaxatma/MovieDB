...
public class NowPlayingActivity extends AppCompatActivity {
    ...
    private Toolbar tb_now_playing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb_now_playing = findViewById(R.id.tb_now_playing);

        view_model = new ViewModelProvider(NowPlayingActivity.this).get(MovieViewModel.class);
        view_model.getNowPlaying();
        view_model.getResultNowPalying().observe(NowPlayingActivity.this, showNowPlaying);
    }
